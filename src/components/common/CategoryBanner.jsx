const CategoryBanner = ({ image, title }) => {
  return (
    <div className="relative h-[250px] lg:h-[400px] overflow-hidden group">
      ...
      <div className="absolute bottom-0 left-0 p-4 pe-12">
        <span
          className="absolute bg-myBlue-1 inset-0 z-0 pointer-events-none transform origin-top-left transition-transform duration-300 group-hover:scale-75"
          style={{
